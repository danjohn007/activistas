            ...
            <main class="col-md-10 ms-sm-auto px-md-4">
                ...
                <?php if (APP_ENV === 'development'): ?>
                    ...
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <h6><i class="fas fa-bug me-2"></i>Modo Debug - Datos Cargados:</h6>
                        <ul class="mb-0">
                            <li>Actividades por Tipo: <strong><?= count($activitiesByType) ?></strong> registros</li>
                            <li>Estadísticas de Usuarios: <strong><?= count($userStats) ?></strong> roles</li>
                            <li>Actividades Mensuales: <strong><?= count($monthlyActivities) ?></strong> meses</li>
                            <li>Ranking de Equipos: <strong><?= count($teamRanking) ?></strong> equipos</li>
                            <li>Actividades Recientes: <strong><?= count($recentActivities) ?></strong> actividades</li>
                            <li>Usuarios Pendientes: <strong><?= count($pendingUsers) ?></strong> usuarios</li>
                        </ul>
                        <?php if (empty($activitiesByType) && empty($userStats)): ?>
                            <hr>
                            <p class="mb-0"><strong>Posibles causas:</strong> No hay datos en la base de datos o hay un error de conexión.</p>
                        <?php endif; ?>
                        <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                    </div>
                <?php endif; ?>
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                        <div class="card bg-secondary text-white">
                            <div class="card-body text-center">
                                ...
                                <h5><?= number_format(count($recentActivities)) ?></h5>
                                <small>Actividades Recientes</small>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="donut-chart">
                                        <?php foreach ($userStats as $rol => $stats): ?>
                                            <div class="donut-item">
                                                <div class="donut-circle role-<?= strtolower($rol) ?>">
                                                    <?= $stats['total'] ?>
                                                </div>
                                        ...
                                        <div class="ranking-item">
                                            ...
                                            <div class="ranking-info">
                                                ...
                                                <small class="text-muted">
                                                    <?= $team['total_activistas'] ?> activistas
                                                </small>
                                            </div>
