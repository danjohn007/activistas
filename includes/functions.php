...
// Subir archivo
function uploadFile($file, $uploadDir, $allowedTypes = ['jpg', 'jpeg', 'png', 'gif'], $isProfile = false, $maxSizeOverride = null) {
    ...
    if ($maxSizeOverride !== null) {
        $maxSize = $maxSizeOverride;
        $maxSizeMB = round($maxSize / 1048576) . 'MB';
    } else {
